...
source=Path('/home/coder/share/drawer-no-unneeded-stop-20260915/dataset');root=Path('/home/coder/share/drawer-no-unneeded-stop-20260915/local-review-package');dest=root/'review';(dest/'videos').mkdir(parents=True,exist_ok=True)
def run(ep):
